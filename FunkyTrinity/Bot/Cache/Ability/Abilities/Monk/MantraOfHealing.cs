...
{
	public class MantraOfHealing : Ability, IAbility
	{
		public MantraOfHealing() : base()
		{
		}
		...
		public override void SetupAbilityForUse()
		{
			...
			if (this.ExecutionType.HasFlag(AbilityUseType.ClusterTarget) && CheckClusterConditions(this.ClusterConditions))
				//Cluster ACDGUID
			{
			...
			if (this.ExecutionType.HasFlag(AbilityUseType.ClusterLocation) && CheckClusterConditions(this.ClusterConditions))
			...
			if (this.ExecutionType.HasFlag(AbilityUseType.ClusterTargetNearest) && CheckClusterConditions(this.ClusterConditions))
				//Cluster Target Position
			{
		...
		{
			get { return SNOPower.Monk_MantraOfHealing; }
		}
	}
}
