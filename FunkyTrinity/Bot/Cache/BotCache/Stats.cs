				...
				internal class ItemStatistics
				{
					 ...
					 public class CurrentGameItemStats
					 {
						  ...
						  public int[] temp_LootedTotals()
						  {
								...
								for (int i=0; i<6; i++)
								{
									 tmp_LootedTotals[i]+=Bot.Stats.Statistics.ProfileStats.CurrentProfile.ItemStats.lootedItemTotals[i];
								}
						  ...
						  public int[] temp_StashedTotals()
						  {
								...
								for (int i=0; i<6; i++)
								{
									 tmp_StashedTotals[i]+=Bot.Stats.Statistics.ProfileStats.CurrentProfile.ItemStats.stashedItemTotals[i];
								}
				...
				internal class ProfileStatisics
				{
					 ...
					 public void UpdateProfileChanged()
					 {
						  ...
						  if (CurrentProfile!=null&&CurrentProfile.ProfileName!=currentProfile)
						  {
								...
								Bot.Stats.Statistics.ItemStats.CurrentGame.ProfileChanged(CurrentProfile.ItemStats);
					 ...
					 public void OutputReport()
					 {
						  ...
						  Bot.Stats.Statistics.GameStats.Update();
						  Bot.Stats.Statistics.ItemStats.CurrentGame.ProfileChanged(CurrentProfile.ItemStats);
						  Bot.Stats.Statistics.ItemStats.Update();
						  ...
						  {
								TimeSpan gameDuration=DateTime.Now.Subtract(Bot.Stats.Statistics.ItemStats.CurrentGame.TimeTrackingBegan).Duration();
								...
								LogWriter.WriteLine("Death Count: "+Bot.Stats.Statistics.GameStats.CurrentGame.Deaths);
								LogWriter.WriteLine("");
								LogWriter.WriteLine("Item Totals: Looted ("+Bot.Stats.Statistics.ItemStats.CurrentGame.LootTotal()+") / Stashed ("+Bot.Stats.Statistics.ItemStats.CurrentGame.StashTotal()+")");
								double itemLootedPerMinTotal=Math.Round(Bot.Stats.Statistics.ItemStats.CurrentGame.LootTotal()/gameDuration.TotalMinutes, 3);
								double itemStashedPerMinTotal=Math.Round(Bot.Stats.Statistics.ItemStats.CurrentGame.StashTotal()/gameDuration.TotalMinutes, 3);
								...
								foreach (var item in Bot.Stats.Statistics.ItemStats.CurrentGame.droppedItemTotals.Keys)
								{
									 int[] totals=Bot.Stats.Statistics.ItemStats.CurrentGame.droppedItemTotals[item];
