	 ...
	 public partial class Funky
	 {
		  internal class DemonHunter : Player
		  {
				...
				public override Ability AbilitySelector(bool bCurrentlyAvoiding=false, bool bOOCBuff=false, bool bDestructiblePower=false)
				{
					 ...
					 #region Shadow Power
					 // Shadow Power
					 if (!bOOCBuff&&Bot.Class.HotbarAbilities.Contains(SNOPower.DemonHunter_ShadowPower)&&!Bot.Character.bIsIncapacitated&&
						 ...
						 (Bot.Class.AbilityUseTimer(SNOPower.DemonHunter_ShadowPower)||Bot.Character.dCurrentHealthPct<0.25d&&PowerManager.CanCast(SNOPower.DemonHunter_ShadowPower)))
					 {
					 ...
					 #region Smoke Screen
					 // Smoke Screen
					 if (!bOOCBuff&&Bot.Class.HotbarAbilities.Contains(SNOPower.DemonHunter_SmokeScreen)
						 ...
						 &&Bot.Class.AbilityUseTimer(SNOPower.DemonHunter_SmokeScreen))
					 {
					 ...
					 #region Preparation
					 // Preparation
					 if (!bOOCBuff&&Bot.Class.HotbarAbilities.Contains(SNOPower.DemonHunter_Preparation)&&!Bot.Character.bIsIncapacitated&&
						 Bot.Character.dDiscipline<=9&&Bot.Combat.iAnythingWithinRange[RANGE_40]>=1&&
						 Bot.Class.AbilityUseTimer(SNOPower.DemonHunter_Preparation)&&PowerManager.CanCast(SNOPower.DemonHunter_Preparation))
					 {
					 ...
					 #region Evasive Fire
					 // Evasive Fire
					 if (!bOOCBuff&&Bot.Class.HotbarAbilities.Contains(SNOPower.DemonHunter_EvasiveFire)&&!Bot.Character.bIsIncapacitated&&
						 (Bot.Combat.iAnythingWithinRange[RANGE_20]>=1||Bot.Target.CurrentTarget.RadiusDistance<=30f)&&
						 Bot.Class.AbilityUseTimer(SNOPower.DemonHunter_EvasiveFire)&&
						 ((this.RuneIndexCache[SNOPower.DemonHunter_EvasiveFire]!=0||DateTime.Now.Subtract(dictAbilityLastUse[SNOPower.DemonHunter_EvasiveFire]).TotalMilliseconds>2750)||Bot.Character.dCurrentEnergyPct<0.25))
					 {
					 ...
					 #region Companion
					 // Companion
					 if (!Bot.Character.bIsIncapacitated&&Bot.Class.HotbarAbilities.Contains(SNOPower.DemonHunter_Companion)&&Bot.Character.PetData.DemonHunterPet==0&&
						 Bot.Character.dDiscipline>=10&&Bot.Class.AbilityUseTimer(SNOPower.DemonHunter_Companion))
					 {
					 ...
					 // Sentry Turret
					 if (!bOOCBuff&&!Bot.Character.bIsIncapacitated&&Bot.Class.HotbarAbilities.Contains(SNOPower.DemonHunter_Sentry)&&
						 ...
						 Bot.Character.dCurrentEnergy>=30&&Bot.Class.AbilityUseTimer(SNOPower.DemonHunter_Sentry))
					 {
					 ...
					 // Marked for Death
					 if (!bOOCBuff&&!bCurrentlyAvoiding&&Bot.Class.HotbarAbilities.Contains(SNOPower.DemonHunter_MarkedForDeath)&&!Bot.Character.bIsIncapacitated&&Bot.Character.dDiscipline>=3&&
						 ...
						 Bot.Class.AbilityUseTimer(SNOPower.DemonHunter_MarkedForDeath))
					 {
					 ...
					 #region Vault
					 // Vault
					 if (!bOOCBuff&&!bCurrentlyAvoiding&&Bot.Class.HotbarAbilities.Contains(SNOPower.DemonHunter_Vault)&&!Bot.Character.bIsRooted&&!Bot.Character.bIsIncapacitated&&
						 ...
						 Bot.Character.dDiscipline>=8&&Bot.Class.AbilityUseTimer(SNOPower.DemonHunter_Vault)&&PowerManager.CanCast(SNOPower.DemonHunter_Vault))
					 {
					 ...
					 // Rain of Vengeance
					 if (!bOOCBuff&&Bot.Class.HotbarAbilities.Contains(SNOPower.DemonHunter_RainOfVengeance)&&!Bot.Character.bIsIncapacitated&&
						 (Bot.Combat.iAnythingWithinRange[RANGE_25]>=7||Bot.Combat.iElitesWithinRange[RANGE_25]>=1)&&
						 Bot.Class.AbilityUseTimer(SNOPower.DemonHunter_RainOfVengeance)&&PowerManager.CanCast(SNOPower.DemonHunter_RainOfVengeance))
					 {
					 ...
					 // Cluster Arrow
					 if (!bOOCBuff&&!bCurrentlyAvoiding&&Bot.Class.HotbarAbilities.Contains(SNOPower.DemonHunter_ClusterArrow)&&!Bot.Character.bIsIncapacitated&&
						 ...
						 Bot.Class.AbilityUseTimer(SNOPower.DemonHunter_ClusterArrow))
					 {
					 ...
					 #region Multi Shot
					 // Multi Shot
					 if (!bOOCBuff&&!bCurrentlyAvoiding&&Bot.Class.HotbarAbilities.Contains(SNOPower.DemonHunter_Multishot)
					 ...
					 // Fan of Knives
					 if (!bOOCBuff&&Bot.Class.HotbarAbilities.Contains(SNOPower.DemonHunter_FanOfKnives)&&!Bot.Character.bIsIncapacitated&&
						 Bot.Character.dCurrentEnergy>=20&&
						 (Bot.Combat.iAnythingWithinRange[RANGE_15]>=4||Bot.Combat.iElitesWithinRange[RANGE_15]>=1)&&
						 Bot.Class.AbilityUseTimer(SNOPower.DemonHunter_FanOfKnives))
					 {
					 ...
					 if (!bOOCBuff&&!bCurrentlyAvoiding&&Bot.Class.HotbarAbilities.Contains(SNOPower.DemonHunter_Strafe)&&!Bot.Character.bIsIncapacitated&&!Bot.Character.bIsRooted&&
						  // Only if within 25 foot of main target
						 Bot.Target.CurrentTarget.RadiusDistance<=15f&&
						  // Check for energy reservation amounts
						 ((Bot.Character.dCurrentEnergy>=15&&!Bot.Character.bWaitingForReserveEnergy)||Bot.Character.dCurrentEnergy>=this.iWaitingReservedAmount))
					 {
					 ...
					 #region Spike Trap
					 // Spike Trap
					 if (!bOOCBuff&&!Bot.Character.bIsIncapacitated&&Bot.Class.HotbarAbilities.Contains(SNOPower.DemonHunter_SpikeTrap)&&
						 ...
						 Bot.Character.dCurrentEnergy>=30&&Bot.Class.AbilityUseTimer(SNOPower.DemonHunter_SpikeTrap))
					 {
					 ...
					 #region Caltrops
					 // Caltrops
					 if (!bOOCBuff&&Bot.Class.HotbarAbilities.Contains(SNOPower.DemonHunter_Caltrops)&&!Bot.Character.bIsIncapacitated&&
						 Bot.Character.dDiscipline>=6&&(Bot.Combat.iAnythingWithinRange[RANGE_30]>=2||Bot.Combat.iElitesWithinRange[RANGE_40]>=1)&&
						 Bot.Class.AbilityUseTimer(SNOPower.DemonHunter_Caltrops))
					 {
					 ...
					 // Elemental Arrow
					 if (!bOOCBuff&&!bCurrentlyAvoiding&&!Bot.Target.CurrentTarget.IsTreasureGoblin&&Bot.Class.HotbarAbilities.Contains(SNOPower.DemonHunter_ElementalArrow)&&!Bot.Character.bIsIncapacitated&&
						 ...
						 Bot.Target.CurrentTarget.SNOID!=5210))||Bot.Character.dCurrentEnergy>=this.iWaitingReservedAmount))
					 {

						  // Players with grenades *AND* elemental arrow should spam grenades at close-range instead
						  if (Bot.Class.HotbarAbilities.Contains(SNOPower.DemonHunter_Grenades)&&Bot.Target.CurrentTarget.RadiusDistance<=18f)
					 ...
					 #region Chakram
					 // Chakram
					 if (!bOOCBuff&&!bCurrentlyAvoiding&&Bot.Class.HotbarAbilities.Contains(SNOPower.DemonHunter_Chakram)&&!Bot.Character.bIsIncapacitated&&
						  // If we have elemental arrow or rapid fire, then use chakram as a 110 second buff, instead
						 ((!Bot.Class.HotbarAbilities.Contains(SNOPower.DemonHunter_ClusterArrow))||
						 DateTime.Now.Subtract(dictAbilityLastUse[SNOPower.DemonHunter_Chakram]).TotalMilliseconds>=110000)&&
						 ((Bot.Character.dCurrentEnergy>=10&&!Bot.Character.bWaitingForReserveEnergy)||Bot.Character.dCurrentEnergy>=this.iWaitingReservedAmount))
					 {
					 ...
					 #region Rapid Fire
					 // Rapid Fire
					 if (!bOOCBuff&&!bCurrentlyAvoiding&&Bot.Class.HotbarAbilities.Contains(SNOPower.DemonHunter_RapidFire)&&!Bot.Character.bIsIncapacitated&&
					 ...
					 #region Impale
					 // Impale
					 if (!bOOCBuff&&!bCurrentlyAvoiding&&Bot.Class.HotbarAbilities.Contains(SNOPower.DemonHunter_Impale)&&!Bot.Character.bIsIncapacitated&&
						 ((Bot.Character.dCurrentEnergy>=25&&!Bot.Character.bWaitingForReserveEnergy)||Bot.Character.dCurrentEnergy>=this.iWaitingReservedAmount)&&
					 ...
					 // Hungering Arrow
					 if (!bOOCBuff&&!bCurrentlyAvoiding&&Bot.Class.HotbarAbilities.Contains(SNOPower.DemonHunter_HungeringArrow)&&!Bot.Character.bIsIncapacitated)
					 {
					 ...
					 // Entangling shot
					 if (!bOOCBuff&&!bCurrentlyAvoiding&&Bot.Class.HotbarAbilities.Contains(SNOPower.DemonHunter_EntanglingShot)&&!Bot.Character.bIsIncapacitated&&(!Bot.Target.CurrentTarget.IsMissileReflecting||Bot.Character.dCurrentEnergy<10))
					 {
					 ...
					 #region Bola Shot
					 // Bola Shot
					 if (!bOOCBuff&&!bCurrentlyAvoiding&&Bot.Class.HotbarAbilities.Contains(SNOPower.DemonHunter_BolaShot)&&!Bot.Character.bIsIncapacitated&&(!Bot.Target.CurrentTarget.IsMissileReflecting||Bot.Character.dCurrentEnergy<10))
					 {
					 ...
					 #region Grenades
					 // Grenades
					 if (!bOOCBuff&&!bCurrentlyAvoiding&&Bot.Class.HotbarAbilities.Contains(SNOPower.DemonHunter_Grenades)&&!Bot.Character.bIsIncapacitated)
					 {
