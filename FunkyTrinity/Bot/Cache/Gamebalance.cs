...
{139557556, new CacheBalance(63, ItemType.Axe, true, FollowerType.None)}, //Axe_norm_unique_flippy_04-39065
		  ...
		  private static HashSet<int> HashPlansPropertiesSix=new HashSet<int>
		  {
		  ...
		  private static HashSet<int> HashPlansPropertiesFive=new HashSet<int>
		  {
		  ...
		  private static HashSet<int> HashPlansPropertiesFour=new HashSet<int>
		  {
		  ...
		  private static HashSet<int> HashPlansArchonGauntlets=new HashSet<int>
		  {
				-1427340245,-1427345983,-1427326253,-1427329159
		  };
		  private static HashSet<int> HashPlansArchonSpaulders=new HashSet<int>
		  {
				1194999700,1195013692,1194993962,1195010786
		  };
		  private static HashSet<int> HashPlansRazorspikes=new HashSet<int>
		  {
				-1656008187,-1656011093,-1656022179,-1656027917
		  };

		  private static HashSet<int> HashDesignFlawlessStarGem=new HashSet<int>
		  {
				-1171649812,872611723,521743063,2147129183
		  };
		  private static HashSet<int> HashDesignPerfectStarGem=new HashSet<int>
		  {
				-1171613874, 872647661, 521779001, 2147165121
		  };
		  private static HashSet<int> HashDesignRadiantStarGem=new HashSet<int>
		  {
				-1171577936, 872683599, 521814939, 2147201059
		  };
		  private static HashSet<int> HashDesignMarquiseGem=new HashSet<int>
		  {
				-1171541998, 872719537, 521850877, 2147236997
		  };
		  private static HashSet<int> HashDesignAmulet=new HashSet<int>
		  {
