...
namespace FunkyTrinity
{
	 public partial class Funky
	 {
		  internal static cacheSNOPower DemonHunterAbility(bool bCurrentlyAvoiding=false, bool bOOCBuff=false, bool bDestructiblePower=false)
		  {
				...
				{
					 return new cacheSNOPower(SNOPower.DemonHunter_ShadowPower, 0f, vNullLocation, Bot.Character.iCurrentWorldID, -1, 1, 1, USE_SLOWLY);
				}
				// Smoke Screen
				...
				{
					 return new cacheSNOPower(SNOPower.DemonHunter_SmokeScreen, 0f, vNullLocation, Bot.Character.iCurrentWorldID, -1, 1, 1, USE_SLOWLY);
				}
				// Preparation
				...
				{
					 return new cacheSNOPower(SNOPower.DemonHunter_Preparation, 0f, vNullLocation, Bot.Character.iCurrentWorldID, -1, 1, 1, USE_SLOWLY);
				}
				// Evasive Fire
				...
				{
					 return new cacheSNOPower(SNOPower.DemonHunter_Companion, 0f, vNullLocation, Bot.Character.iCurrentWorldID, -1, 2, 1, USE_SLOWLY);
				}
				// Sentry Turret
				...
				{
					 return new cacheSNOPower(SNOPower.DemonHunter_Sentry, 0f, ZetaDia.Me.Position, Bot.Character.iCurrentWorldID, -1, 0, 0, false);
				}
				// Marked for Death
				...
				{
					 return new cacheSNOPower(SNOPower.DemonHunter_MarkedForDeath, 40f, vNullLocation, Bot.Character.iCurrentWorldID, Bot.Target.ObjectData.AcdGuid.Value, 1, 1, USE_SLOWLY);
				}
				// Vault
					...
					Bot.Character.dDiscipline>=8&&AbilityUseTimer(SNOPower.DemonHunter_Vault)&&PowerManager.CanCast(SNOPower.DemonHunter_Vault))
				{
					 ...
					 return new cacheSNOPower(SNOPower.DemonHunter_Vault, 20f, vNewTarget, Bot.Character.iCurrentWorldID, -1, 1, 2, USE_SLOWLY);
				}
				// Rain of Vengeance
				...
				{
					 return new cacheSNOPower(SNOPower.DemonHunter_RainOfVengeance, 0f, vNullLocation, Bot.Character.iCurrentWorldID, -1, 1, 1, USE_SLOWLY);
				}
				// Cluster Arrow
				...
				{
					 return new cacheSNOPower(SNOPower.DemonHunter_ClusterArrow, 69f, vNullLocation, Bot.Character.iCurrentWorldID, Bot.Target.ObjectData.AcdGuid.Value, 1, 1, USE_SLOWLY);
				}
				// Multi Shot
					 ...
					 &&!Bot.Character.bIsIncapacitated&&Bot.Character.dCurrentEnergy>=30)
				{
					 ...
					 if (thisCacheUnitObj!=null&&thisCacheUnitObj.IsMissileReflecting)
						  return new cacheSNOPower(SNOPower.DemonHunter_Multishot, 55f, vNullLocation, Bot.Character.iCurrentWorldID, thisCacheUnitObj.AcdGuid.Value, 1, 1, USE_SLOWLY);
					 ...
					 if (clusters.Count>0)
					 {
						  ...
						  return new cacheSNOPower(SNOPower.DemonHunter_Multishot, 55f, pos, Bot.Character.iCurrentWorldID, -1, 1, 1, USE_SLOWLY);
				...
				{
					 return new cacheSNOPower(SNOPower.DemonHunter_FanOfKnives, 0f, vNullLocation, Bot.Character.iCurrentWorldID, -1, 1, 1, USE_SLOWLY);
				}
...
>>>>>>> origin/Refractoring
					 ...
					 return new cacheSNOPower(SNOPower.DemonHunter_Strafe, 25f, Bot.Combat.vSideToSideTarget, Bot.Character.iCurrentWorldID, -1, 0, 0, USE_SLOWLY);
				}
				// Spike Trap
					...
					Bot.Character.dCurrentEnergy>=30&&AbilityUseTimer(SNOPower.DemonHunter_SpikeTrap))
				{
					 ...
					 return new cacheSNOPower(SNOPower.DemonHunter_SpikeTrap, 40f, vNewTarget, Bot.Character.iCurrentWorldID, -1, 1, 1, USE_SLOWLY);
				}
				// Caltrops
				...
				{
					 return new cacheSNOPower(SNOPower.DemonHunter_Caltrops, 0f, vNullLocation, Bot.Character.iCurrentWorldID, -1, 1, 1, USE_SLOWLY);
				}
				// Elemental Arrow
				if (!bOOCBuff&&!bCurrentlyAvoiding&&!Bot.Target.ObjectData.IsTreasureGoblin&&HotbarAbilitiesContainsPower(SNOPower.DemonHunter_ElementalArrow)&&!Bot.Character.bIsIncapacitated&&
					...
					Bot.Target.ObjectData.SNOID!=5210))||Bot.Character.dCurrentEnergy>=Bot.Class.iWaitingReservedAmount))
				{
