		  ...
		  public static Vector3 FindSafeZone(bool bFindAntiStuckSpot, int iAntiStuckAttempts, Vector3 vNearbyPoint, bool bKitingSpot=false)
		  {
				if (!bFindAntiStuckSpot)
				{
					 ...
					 bHasEmergencyTeleportUp=(
						  // Leap is available
						  (!Bot.Character.bIsIncapacitated&&HotbarAbilitiesContainsPower(SNOPower.Barbarian_Leap)&&
						  ...
						  (!Bot.Character.bIsIncapacitated&&HotbarAbilitiesContainsPower(SNOPower.Barbarian_Whirlwind)&&
						  ...
						  (!Bot.Character.bIsIncapacitated&&HotbarAbilitiesContainsPower(SNOPower.Monk_TempestRush)&&
						  ...
						  (!Bot.Character.bIsIncapacitated&&HotbarAbilitiesContainsPower(SNOPower.Wizard_Teleport)&&
								Bot.Character.dCurrentEnergy>=15&&
								PowerManager.CanCast(SNOPower.Wizard_Teleport))||
						  // Archon Teleport is available
						  (!Bot.Character.bIsIncapacitated&&HotbarAbilitiesContainsPower(SNOPower.Wizard_Archon_Teleport)&&
