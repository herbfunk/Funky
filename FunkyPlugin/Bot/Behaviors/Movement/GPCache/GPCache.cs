...
namespace FunkyTrinity
{
	 public partial class Funky
	 {
		  public static partial class GridPointAreaCache
		  {
				...
				///</summary>
				public static int MovementGPRectMaxCount=3;
				///<summary>
				///This sets whether or not to cache GPCs during routine movement.
				///</summary>
				public static bool EnableBacktrackGPRcache=true;
				///<summary>
				///The minimum range required to cache a new GPC during routine movement.
				///</summary>
				public static double MinimumRangeBetweenMovementGPRs=20f;

				///<summary>
				///Cache of GPCs created during routine movement.
				///</summary>
				public static List<GPRectangle> cacheMovementGPRs=new List<GPRectangle>();
