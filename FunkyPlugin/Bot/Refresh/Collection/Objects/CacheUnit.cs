					 ...
					 if (this.Weight!=1)
					 {
						  ...
						  else
						  {
								...
								else
								{
									 ...
									 if (this.RadiusDistance<iCurrentMaxKillRadius)
									 {
										  ...
										  this.Weight+=(RangeModifier*(1-(this.RadiusDistance/iCurrentMaxKillRadius)));
									 }
									 ...
									 if (this.IsTreasureGoblin)
									 {
										  ...
										  if (lastGoblinTime==DateTime.Today)
										  {
												...
												Logging.Write("[Funky] Goblin #"+iTotalNumberGoblins.ToString()+" in sight. Distance="+this.CentreDistance);
										  }
										  else
										  {
				...
				public override bool UpdateData()
				{
					 ...
					 if (!base.MonsterTypeIsHostile())
					 {
						  ...
						  if (Bot.Character.bIsInTown)
						  {
								...
								if (isNPC)
									 dbRefresh.IgnoreThisObject(this, true, true);
					 ...
					 if (this.ref_DiaUnit==null)
					 {
						  ...
						  } catch { Logging.WriteVerbose("Failure to convert obj to DiaUnit!"); return false; }
					 }
					 ...
					 if (!this.MaximumHealth.HasValue)
					 {
						  ...
						  } catch { Logging.WriteVerbose("Failure to get maximum health for {0}", base.InternalName); return false; }
					 }
