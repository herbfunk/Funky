...
namespace FunkyTrinity
{
    public partial class Funky
    {
		  ...
		  //Time each one remains in MS
		  private static readonly Dictionary<AvoidanceType, int> dictAvoidanceDefaultTimeouts=new Dictionary<AvoidanceType, int>
            {

                {AvoidanceType.ArcaneSentry, 20000},{AvoidanceType.Dececrator, 15000},{AvoidanceType.MoltenCore, 7500},{AvoidanceType.MoltenTrail, 15000},{AvoidanceType.Frozen, 20000},{AvoidanceType.PlagueCloud, 250000},    
                                                                                      
                {AvoidanceType.BeeProjectile, 12000},{AvoidanceType.LacuniBomb,1500},{AvoidanceType.ShamanFireBall,4000},

					 {AvoidanceType.PoisonTree, 7500},{AvoidanceType.PlagueHand, 7500},{AvoidanceType.MageFirePool, 6000},	
  
					 {AvoidanceType.AzmodanPool, 25000},{AvoidanceType.AzmodanFireball, 25000},{AvoidanceType.AzmodanBodies, 25000},  
					 {AvoidanceType.BelialGround, 25000},
                {AvoidanceType.DiabloPrison, 10000},{AvoidanceType.DiabloMetor, 20000},
		  ...
		  private static readonly Dictionary<AvoidanceType, double> dictAvoidanceHealthDefaultsType=new Dictionary<AvoidanceType, double>
            {

                {AvoidanceType.ArcaneSentry, 1},{AvoidanceType.Dececrator, 1},{AvoidanceType.MoltenCore, 1},{AvoidanceType.MoltenTrail, 0.5},{AvoidanceType.Frozen, 0.5},{AvoidanceType.PlagueCloud, 0.5},    
		  ...
		  private static readonly Dictionary<AvoidanceType, double> dictAvoidanceHealthMeleeDefault=new Dictionary<AvoidanceType, double>
            {

                {AvoidanceType.ArcaneSentry, 1},{AvoidanceType.Dececrator, 1},
                {AvoidanceType.BeeProjectile,1}
