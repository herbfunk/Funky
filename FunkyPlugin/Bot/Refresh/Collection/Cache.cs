...
namespace FunkyTrinity
{
	 public partial class Funky
	 {
		  ...
		  private static HashSet<int> hashSNONavigationObstacles=new HashSet<int> {
            174900, 191459, 54908, 58379, 204168, 3341, 185391, 123325, 
        };
		  ...
		  public static readonly Dictionary<int, int> dictSNONavigationSize=new Dictionary<int, int> { 
            {174900, 10}, {191459, 13}, {54908, 15}, {58379,10}, {204168, 16}, {3341, 13}, {185391,25},
         };
		  ...
		  // 
		  /*
		  {113932, 8},{155255, 8},{5792, 8},{174496, 8},{108612, 8},
		              {2972, 10}, {80357, 16}, {116508, 10},  
             {181228, 14},    {193963, 10}, {159066, 12}, {160570, 12},
            {55325, 14}, {5718, 14}, {5909, 10},  {108194, 16},  {62653, 14}, {92529, 15},
		  */
		  ...
		  private static readonly HashSet<int> hashDestructableLocationTarget=new HashSet<int> { 
            170657, 116409, 121586, 3016, 121586,80231,
         };
