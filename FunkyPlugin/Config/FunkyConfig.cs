...
namespace FunkyTrinity
{
	 public partial class Funky
	 {
		  ...
		  public static LootWindow funkyConfigWindow;
		  ...
		  public partial class LootWindow : Window
		  {
				...
				public LootWindow()
				{
					 ...
					 {
						  Content="Attempt avoidance movements",
						  Width=300,
						  Height=30,
					 ...
					 LBcharacterAvoidance.Items.Add(CBAttemptAvoidanceMovements);

					 CheckBox CBAdvancedProjectileTesting=new CheckBox
					 {
						  Content="Use Advanced Projectile Testing",
						  Width=300,
						  Height=30,
					 ...
					 LBcharacterAvoidance.Items.Add(CBAdvancedProjectileTesting);

					 LBcharacterAvoidance.Items.Add("Avoidance \t\t\t Radius \t\t\t\t\t HealthPercent");
					 LBcharacterAvoidance.Items.Add("");
					 ...
					 for (int i=0; i<avoidanceTypes.Length-1; i++)
					 {
						  ...
						  LBcharacterAvoidance.Items.Add(avoidanceString);
						  ...
						  StackPanel avoidanceSPanel=new StackPanel
						  {
								Width=600,
								Height=30,
								Orientation=Orientation.Horizontal,
						  };
						  avoidanceSPanel.Children.Add(avoidanceRadius);
						  avoidanceSPanel.Children.Add(TBavoidanceRadius[i]);

						  avoidanceSPanel.Children.Add(avoidanceHealth);
						  avoidanceSPanel.Children.Add(TBavoidanceHealth[i]);

						  LBcharacterAvoidance.Items.Add(avoidanceSPanel);
					 }
					 ...
					 Label Lbl_aretry_min=new Label
					 {
						  Content="Minimum Value",
						  HorizontalAlignment=System.Windows.HorizontalAlignment.Left,
						  HorizontalContentAlignment=System.Windows.HorizontalAlignment.Stretch,
					 };
					 LBcharacterCombat.Items.Add("Avodiance Retry Time");
					 ...
					 Label Lbl_aretry_max=new Label
					 {
					 ...
					 AvoidRetryTimeStackPanel.Children.Add(Lbl_aretry_min);
					 ...
					 AvoidRetryTimeStackPanel.Children.Add(Lbl_aretry_max);
					 ...
					 #region KitingRetry
					 LBcharacterCombat.Items.Add("Kiting Retry Milliseconds");
					 Label Lbl_kretry_min=new Label
					 {
						  Content="Minimum Value",
						  HorizontalAlignment=System.Windows.HorizontalAlignment.Left,
						  HorizontalContentAlignment=System.Windows.HorizontalAlignment.Stretch,
					 ...
					 Label Lbl_kretry_max=new Label
					 {
						  Content="Maximum Value",
						  HorizontalAlignment=System.Windows.HorizontalAlignment.Right,
						  HorizontalContentAlignment=System.Windows.HorizontalAlignment.Stretch,
					 ...
					 #region Kiting
					 LBcharacterCombat.Items.Add("Minimum Kite Distance");
					 ...
					 lbGilesContent.Items.Add("Minimum Item Levels");
					 #region minimumWeaponILevel
					 TBMinimumWeaponLevel=new TextBox[2];
					 lbGilesContent.Items.Add("Weapons \t\t\t Magical \t\t\t\t\t Rare");
					 ...
					 lbGilesContent.Items.Add("Armor   \t\t\t Magical \t\t\t\t\t Rare");
					 ...
					 lbGilesContent.Items.Add("Jewelery \t\t\t Magical \t\t\t\t\t Rare");
					 ...
					 lbGilesContent.Items.Add("Minimum Misc Item Level");
				 ...
				 {
					  Content="Ignore Clustering Logic on Bot Low HP",
					  Width=300,
					  Height=30,
					 ...
					 lbTargetCluster.Items.Add("Bot Low HP Value");
		  ...
		  public static Settings_Funky SettingsFunky=new Settings_Funky(false, false, false, false, false, false, false, 4, 8, 3, 1.5d, true, 20, false, false, "hard", "Rare", "Rare", true, false, 0, 5, 15, 20, 0.5d, 0.5d, false, 2, 500, false, 50, 30, 40, new int[1], new int[1], new int[1], 1, 100, 300, new bool[3], 60, true, true, true, 59, false, 70000, 16000, 15000, false, false);
		  ...
		  public class Settings_Funky
		  {
				...
				{
					 AvoidanceRecheckMaximumRate=500;
					 AvoidanceRecheckMinimumRate=0;
					 KitingRecheckMaximumRate=1500;
					 KitingRecheckMinimumRate=500;
					 ItemRulesSalvaging=false;
					 ...
					 ClusterDistance=10d;
					 ClusterMinimumUnitCount=1;
					 IgnoreClusterLowHPValue=0.5d;
