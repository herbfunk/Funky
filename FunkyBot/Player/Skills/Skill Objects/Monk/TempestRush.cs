		  ...
		  public override void Initialize()
		  {
				...
				FcriteriaCombat=() =>
				{
					...
					return (isChanneling&&FunkyGame.Hero.dCurrentEnergy>channelingCost)||(FunkyGame.Hero.dCurrentEnergy>40)
					       &&(!Bot.Character.Class.bWaitingForSpecial||FunkyGame.Hero.dCurrentEnergy>=Bot.Character.Class.iWaitingReservedAmount);
				};
				...
				FCombatMovement=v =>
				{
					...
					//If channeling, check if energy is greater then 10.. else only start when energy is at least -40-
					if ((isChanneling&&FunkyGame.Hero.dCurrentEnergy>channelingCost)||(FunkyGame.Hero.dCurrentEnergy>15)&&!Bot.Character.Class.bWaitingForSpecial)
					{
