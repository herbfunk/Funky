...
namespace FunkyBot.Skills.Monk
{
	public class DashingStrike : Skill
	{
		...
		public override void Initialize()
		{
			...
			//		MinimumDistance=30,
			//		Criteria = () => (ObjectCache.Obstacles.ReturnAllIntersectingObjects(FunkyGame.Hero.Position, Bot.Targeting.Cache.CurrentTarget.Position, ObstacleType.Monster).Count > 2)
			//	}
			//);
			...
			FCombatMovement = (v) =>
			{
				...
				if (!Bot.Character.Class.bWaitingForSpecial && Funky.Difference(FunkyGame.Hero.Position.Z, v.Z) <= 4)
				{
