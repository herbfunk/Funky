	...
	public class CycloneStrike : Skill
	{
		...
		public override void Initialize()
		{
			...
			FcriteriaCombat = () =>
			{
				...
				if (!Hotbar.HasPower(SNOPower.Monk_ExplodingPalm) || !Bot.Targeting.Cache.CurrentUnitTarget.SkillsUsedOnObject.ContainsKey(SNOPower.Monk_ExplodingPalm)) return true; //Non Exploding Palm Check
