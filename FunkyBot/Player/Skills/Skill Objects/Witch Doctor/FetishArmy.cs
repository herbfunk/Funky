...
namespace FunkyBot.Skills.WitchDoctor
{
	public class FetishArmy : Skill
	{
		...
		public override void Initialize()
		{
			...
			{
				IsBuff = true;
				FcriteriaBuff = () => Bot.Targeting.Cache.Environment.HeroPets.WitchdoctorFetish < GetTotalFetishCount();
				FcriteriaCombat = () => Bot.Targeting.Cache.Environment.HeroPets.WitchdoctorFetish < GetTotalFetishCount();
			}
		}
