...
namespace FunkyBot.AbilityFunky.Abilities.Barb
{
	 public class SeismicSlam : Ability, IAbility
	 {
		  ...
		  public override void Initialize()
		  {
				...
				Cost=Bot.Class.HotBar.RuneIndexCache[SNOPower.Barbarian_SeismicSlam]==3?15:30;
				Range=40;
				...
				ClusterConditions=new ClusterConditions(Bot.Class.HotBar.RuneIndexCache[Power]==4?4d:6d, 40f, 2, true);
