...
namespace fBaseXtensions.Settings
{
	public partial class UserControlAvoidance : UserControl
	{
		...
		public UserControlAvoidance(int Index)
		{
			...
			lbl_AvoidanceName.Text = FunkyBaseExtension.Settings.Avoidance.Avoidances[Index].Type.ToString();

			trackbar_Health.Value=(int)(FunkyBaseExtension.Settings.Avoidance.Avoidances[Index].Health*100);
			this.trackbar_Health.ValueChanged += new System.EventHandler(this.trackbar_Health_ValueChanged);

			trackbar_Radius.Value = (int)FunkyBaseExtension.Settings.Avoidance.Avoidances[Index].Radius;
			this.trackbar_Radius.ValueChanged += new System.EventHandler(this.trackbar_Radius_ValueChanged);

			trackbar_Weight.Value = FunkyBaseExtension.Settings.Avoidance.Avoidances[Index].Weight;
			this.trackbar_Weight.ValueChanged += new System.EventHandler(this.trackbar_Weight_ValueChanged);

			tb_Health.Text = FunkyBaseExtension.Settings.Avoidance.Avoidances[Index].Health.ToString("F2", CultureInfo.InvariantCulture);
			tb_Radius.Text = ((int)FunkyBaseExtension.Settings.Avoidance.Avoidances[Index].Radius).ToString();
			tb_Weight.Text = FunkyBaseExtension.Settings.Avoidance.Avoidances[Index].Weight.ToString();
		}
		...
		private void trackbar_Radius_ValueChanged(object sender, EventArgs e)
		{
			...
			FunkyBaseExtension.Settings.Avoidance.Avoidances[_index].Radius = currentValue;
		}
		...
		private void trackbar_Health_ValueChanged(object sender, EventArgs e)
		{
			...
			FunkyBaseExtension.Settings.Avoidance.Avoidances[_index].Health = currentValue;
		}
		...
		private void trackbar_Weight_ValueChanged(object sender, EventArgs e)
		{
			...
			FunkyBaseExtension.Settings.Avoidance.Avoidances[_index].Weight = currentValue;
		}
	}
}
