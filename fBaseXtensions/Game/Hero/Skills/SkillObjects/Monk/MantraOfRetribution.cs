		 ...
		 public override void Initialize()
		  {
				...
				FcriteriaBuff=() => !Hotbar.HasBuff(SNOPower.X1_Monk_MantraOfRetribution_v2_Passive);

				FcriteriaCombat = () => !Hotbar.HasBuff(SNOPower.X1_Monk_MantraOfRetribution_v2_Passive)
				                      ||
