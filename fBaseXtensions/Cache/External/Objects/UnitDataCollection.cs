	...
	public class UnitDataCollection
	{
		...
		public UnitDataCollection()
		{
			...
			UnitEntries = new HashSet<UnitEntry>
			{
				...
				new UnitEntry(4070, UnitFlags.Normal | UnitFlags.Tough, "FallenChampion_A-941"),
				new UnitEntry(4071, UnitFlags.Normal | UnitFlags.Tough, "FallenChampion_B-1438"),
				new UnitEntry(4072, UnitFlags.Normal | UnitFlags.Tough, "FallenChampion_C-8836"),
				new UnitEntry(4073, UnitFlags.Normal | UnitFlags.Tough, "FallenChampion_D-1012"),
				...
				new UnitEntry(6038, UnitFlags.Normal | UnitFlags.Ranged | UnitFlags.Summoner, "TriuneSummoner_C-10685"),
				new UnitEntry(6039, UnitFlags.Normal | UnitFlags.Ranged | UnitFlags.Summoner, "TriuneSummoner_D-1484"),
				new UnitEntry(6042, UnitFlags.Normal | UnitFlags.Tough, "TriuneVesselActivated_A-13288"),
				new UnitEntry(6046, UnitFlags.Normal | UnitFlags.Tough, "TriuneVessel_A-12145"),
				new UnitEntry(6052, UnitFlags.Normal | UnitFlags.Tough, "Triune_Berserker_A-12360"),
				new UnitEntry(6054, UnitFlags.Normal | UnitFlags.Tough, "Triune_Berserker_C-1562"),
				...
				new UnitEntry(6356, UnitFlags.Normal | UnitFlags.Tough, "Unburied_A-3007"),
				new UnitEntry(6358, UnitFlags.Normal| UnitFlags.Tough, "Unburied_B-12833"),
				new UnitEntry(6359, UnitFlags.Normal| UnitFlags.Tough, "Unburied_C-12299"),
				...
				new UnitEntry(76953, UnitFlags.Unique| UnitFlags.Tough, "Unburied_A_Unique-12652"),
				...
				new UnitEntry(82563, UnitFlags.AdventureModeBoss| UnitFlags.Tough, "Unburied_A_Unique_LeoricBoss-14631"),
				...
				new UnitEntry(176907, UnitFlags.Normal | UnitFlags.Summoner, "trDun_Cath_Skeleton_SummoningMachine-1008"),
				...
				new UnitEntry(346563, UnitFlags.AdventureModeBoss, "InfernalMaiden"),
				...
				new UnitEntry(353823, UnitFlags.AdventureModeBoss, "Raiziel"),
				new UnitEntry(353874, UnitFlags.AdventureModeBoss, "X1_LR_Boss_westmarchBrute"),
				new UnitEntry(354050, UnitFlags.AdventureModeBoss, "X1_LR_Boss_Dark_Angel-16810"),
				new UnitEntry(354144, UnitFlags.AdventureModeBoss, "X1_LR_Boss_BigRed_Izual"),
				...
				new UnitEntry(365906, UnitFlags.AdventureModeBoss| UnitFlags.Tough, "Unburied_C_Unique_01-3328"),
				...
				new UnitEntry(185440, UnitFlags.Normal| UnitFlags.Tough, "Unburied_A_UnburiedAlcoveEvent-3908"),
				new UnitEntry(166452, UnitFlags.Normal | UnitFlags.Summoner, "trOut_Highlands_Goatmen_SummoningMachine_A_Node-22783"),
				...
				new UnitEntry(208824, UnitFlags.Normal | UnitFlags.Summoner, "a2dun_Zolt_Tesla_Tower_Spawner_Cold-50322"),
				new UnitEntry(230757, UnitFlags.Unique | UnitFlags.Ranged | UnitFlags.Fast, "skeletonMage_Fire_B_Unique_BloodGuardian-51017"),
				new UnitEntry(3037, UnitFlags.Normal | UnitFlags.Summoner, "a2dun_Zolt_Round_Spawner-51486"),
				...
				new UnitEntry(361991, UnitFlags.Unique | UnitFlags.Ranged | UnitFlags.Fast, "x1_NightScreamer_Unique_B-2089"),
				new UnitEntry(332075, UnitFlags.Unique, "x1_westmarchBrute_A_Graveyard_Holdout_Event-6859"),
				new UnitEntry(374750, UnitFlags.Unique, "x1_PortalGuardian_A_Borgoth-12119"),
				new UnitEntry(318438, UnitFlags.Normal, "X1_demonTrooper_Chronodemon_Event_ForgottenWar-14981"),
				new UnitEntry(361417, UnitFlags.Unique | UnitFlags.Ranged | UnitFlags.Fast, "x1_westmarchRanged_Unique_B-3956"),
				new UnitEntry(373842, UnitFlags.Unique, "x1_MoleMutant_Melee_Unique_C-26473"),
				new UnitEntry(362307, UnitFlags.Unique, "x1_MoleMutant_Shaman_Unique_A-28985"),
				new UnitEntry(363910, UnitFlags.Unique, "x1_westmarchHound_Leader_Unique_A-31622"),
				new UnitEntry(309462, UnitFlags.Unique | UnitFlags.Fast, "x1_FloaterAngel_Unique_04-35114"),
				new UnitEntry(355870, UnitFlags.Normal, "X1_Westmarch_Male_Event_KingEvent2-40570"),
				new UnitEntry(357018, UnitFlags.Normal, "x1_NPC_Westmarch_Gorrel_NonUnique-40583"),

				new UnitEntry(354378, UnitFlags.Unique | UnitFlags.Ranged, "x1_Squigglet_A_unique_cellarEventB-25201"),
				new UnitEntry(351179, UnitFlags.Unique | UnitFlags.Fast, "x1_BogFamily_melee_A_Unique_DH-2517"),
				new UnitEntry(332399, UnitFlags.Normal, "X1_Rockling_Ranged_Large-8859"),
				new UnitEntry(332398, UnitFlags.Normal, "X1_Rockling_Melee_Large-8875"),
				new UnitEntry(353667, UnitFlags.Unique, "X1_Rockling_Event_RockHive_Queen-9315"),
				new UnitEntry(360242, UnitFlags.Unique | UnitFlags.Fast, "x1_leaperAngel_A_FortressUnique-15190"),
				new UnitEntry(307099, UnitFlags.Unique, "x1_FloaterAngel_Unique_03-31856"),
				new UnitEntry(361973, UnitFlags.Unique, "x1_BogFamily_ranged_Unique_A-28451"),
				new UnitEntry(288471, UnitFlags.Unique, "x1_WickerMan_Unique_A-29253"),
				new UnitEntry(325779, UnitFlags.Unique | UnitFlags.Fast, "X1_BigRed_Chronodemon_Event_Prison-32272"),
				new UnitEntry(374220, UnitFlags.Normal, "X1_demonTrooper_C-37648"),
				new UnitEntry(360864, UnitFlags.Unique, "x1_westmarchBrute_Unique_D-51007"),
				new UnitEntry(289386, UnitFlags.Normal, "X1_graveDiggerGhost-969"),
				new UnitEntry(289387, UnitFlags.Normal, "X1_GhostGuard-1102"),
				new UnitEntry(289388, UnitFlags.Normal, "X1_graveRobberGhost-1114"),
