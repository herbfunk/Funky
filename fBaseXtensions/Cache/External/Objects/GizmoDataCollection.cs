	...
	public class GizmoDataCollection
	{
		...
		public GizmoDataCollection()
		{
			...
			GizmoCache = new HashSet<GizmoEntry>
			{
				...
				new GizmoEntry(379074, PluginGizmoType.Chest, "p1_Cesspools_Ground_Clicky-39539", GizmoTargetTypes.MiscContainer),
				new GizmoEntry(289859, PluginGizmoType.Chest, "x1_Fortress_Ground_Clicky-66204", GizmoTargetTypes.MiscContainer),
				...
				new GizmoEntry(289763, PluginGizmoType.Chest, "x1_Abattoir_weaponRack-5023", GizmoTargetTypes.ItemRack),
				new GizmoEntry(307432, PluginGizmoType.Chest, "x1_westm_Int_WeaponRack-6628", GizmoTargetTypes.ItemRack),
				new GizmoEntry(301981, PluginGizmoType.Chest, "x1_westm_Tub_Tools_A-7975", GizmoTargetTypes.ItemRack),
				new GizmoEntry(289858, PluginGizmoType.Chest, "x1_Fortress_WeaponRack-66101", GizmoTargetTypes.ItemRack),
				new GizmoEntry(379076, PluginGizmoType.Chest, "p1_Cesspools_weaponRack-39531", GizmoTargetTypes.ItemRack),
