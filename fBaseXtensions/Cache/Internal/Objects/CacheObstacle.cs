	...
	public class CacheAvoidance : CacheObstacle
	{
		...
		public override void RefreshObject()
		{
			...
			if (IsProjectileAvoidance)
			{
				...
				{
					FunkyGame.Targeting.Cache.Environment.TriggeringAvoidances.Add(this);
					FunkyGame.Targeting.Cache.Environment.TriggeringAvoidanceRAGUIDs.Add(RAGUID);
					FunkyGame.Targeting.Cache.TravellingAvoidance = true;
					FunkyGame.Targeting.Cache.RequiresAvoidance = true;
				}
			}
			else
			{
				if (CentreDistance < 50f)
					FunkyGame.Targeting.Cache.Environment.NearbyAvoidances.Add(RAGUID);
		...
		public bool UpdateProjectileRayTest()
		{
			...
			if (FunkyBaseExtension.Settings.Avoidance.UseAdvancedProjectileTesting)
			{
	...
	public class CacheServerObject : CacheObstacle
	{
		...
		public override void RefreshObject()
		{
			...
			if (centredistance < 25f)
				FunkyGame.Targeting.Cache.Environment.NearbyObstacleObjects.Add(this);
			...
			//			FunkyGame.Targeting.Environment.TriggeringAvoidances.Add(new CacheAvoidance(this, AvoidanceType.DemonicForge));
			//			FunkyGame.Targeting.Environment.TriggeringAvoidanceRAGUIDs.Add(RAGUID);
			//			FunkyGame.Targeting.RequiresAvoidance = true;
			//		}
			//	}
			//	BlacklistLoops = 5;
			//}
