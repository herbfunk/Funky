...
namespace fBaseXtensions.Navigation
{
	...
	public class Navigation
	{
		...
		{
			return (FunkyGame.Navigation.CurrentGPArea != null && !FunkyGame.Navigation.CurrentGPArea.AllGPRectsFailed
				&& (FunkyGame.Navigation.CurrentGPArea.StartingLocation == FunkyGame.Hero.Position || FunkyGame.Navigation.CurrentGPArea.centerGPRect.Contains(FunkyGame.Hero.Position)));
		}
